...
* [DataLakeHouse.io](https://datalakehouse.io/) - DataLakeHouse.io (aka [DLH.io](https://dlh.io)) is a data consolidation platform for finance and operations. It goes beyond standard ELT no-code functionailty for modern businesses' Data Workers, Data Mechanics, and Data Engineers, where 100+ reliable data integrations for Databases, EDI, SaaS Applications, Cloud Storage, Streaming Services are ready to use for automated data pipelines. DLH.io also builds custom connectors on request so you don't have to and then supports them for you over the long term. It includes de-duplication tools for CRM and other data management features with an emphasis on automation and data management for business value.
