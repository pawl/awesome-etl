...
* [pygrametl](http://www.pygrametl.org/) - An Open-Source framework for Python and Jython which offers commonly used functionality for development of dimensional Extract-Transform-Load (ETL) processes. The framework was designed by and is currently maintained at Aalborg University and released under the BSD 2-Clause license.
