...
* [Xplenty](http://www.xplenty.com/) - "commercial cloud-based data integration platform. Very little to no coding required (except maybe integration through Restful API. Does not support jobs dependencies for the moment."
