...
* [Argo](https://argoproj.github.io/) - Container based workflow management system for Kubernetes. Jobs are specified as a directed acyclic graph (DAG), and each step is executed on container, which runs on a Kubernetes' Pod. There is also support for Airflow DAGs.
